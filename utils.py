...
Some of this code was also copied from https://github.com/jayded/eraserbenchmark
Teng Li
07.10.2021
'''
...
def get_meanloss_and_wi(best_wi):
    keep_num = len(best_wi)
    loss = 0
    wi_list = []
    for wi_info in best_wi:
        loss += wi_info['loss_increase']
        wi_list.append(wi_info['wi_id'])
    mean_loss = loss/keep_num
    return mean_loss, wi_list